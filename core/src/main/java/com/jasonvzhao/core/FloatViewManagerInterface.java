...
public interface FloatViewManagerInterface {
     ...
     * @param floatIntent
     */
    void attach(FloatIntent floatIntent);
     ...
     * @param dokitView
     */
    void detach(AbsFloatView dokitView);
     ...
     * @param dokitView
     */
    void detach(Activity activity, AbsFloatView dokitView);
     ...
     */
    void detach(Class<? extends AbsFloatView> dokitViewClass);
     ...
     * @param dokitViewClass
     */
    void detach(Activity activity, Class<? extends AbsFloatView> dokitViewClass);
     ...
     * @return
     */
    AbsFloatView getDokitView(Activity activity, String tag);
     ...
     * @return
     */
    Map<String, AbsFloatView> getDokitViews(Activity activity);
